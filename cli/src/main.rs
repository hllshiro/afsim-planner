...
use rplan_cli::config::{
    InputConfig, OutputSuccess, Point3D, Diagnostics, Summary, Waypoint, WaypointType,
};
use rplan_cli::error::{ErrorCode, ErrorDetail, OutputFailed};
use rplan_cli::solver::AStarSolver;
...
fn main() {
        ...
        && start.distance_2d(&target_center) > macro_threshold
    {
        ...
        let router = rplan_cli::macro_router::MacroRouter::new(
